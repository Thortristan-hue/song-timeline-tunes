...
export function MainMenu({ onCreateRoom, onJoinRoom }: MainMenuProps) {
  ...
  const tips = [
    "Adulting is hard. Whiskey helps.",
    "Life is short. Eat the damn cake.",
    "Don't trust a fart after Taco Tuesday.",
    "Remember, hangovers are just karma for having too much fun.",
    "You can't buy happiness, but you can buy tequila. Same thing.",
    ...
    "Coffee first, bullshit later.",
    "Never argue when you're naked. You'll lose every time.",
    "If at first you don't succeed, pour another drink.",
