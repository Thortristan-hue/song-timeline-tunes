...
export function HostCurrentPlayerTimeline({ currentTurnPlayer, cardPlacementResult }: HostCurrentPlayerTimelineProps) {
  ...
  return (
    <div className="absolute bottom-6 left-6 right-6 z-20">
      <div className={`bg-white/12 backdrop-blur-2xl rounded-3xl p-6 shadow-xl border border-white/10 transition-all duration-300 ${feedbackAnimation}`}>
