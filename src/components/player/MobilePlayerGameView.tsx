    ...
    return (
      <div 
        className={cn(
          ...
          "px-4 pt-safe-top pb-safe-bottom transition-all duration-300",
          isCorrect 
            ? 'bg-green-500 text-white' 
            : 'bg-red-500 text-white'
        )}
      >
        {/* Simple large result text */}
        <div className="text-center py-16">
          <div className="text-8xl font-black mb-8 animate-pulse">
            {isCorrect ? '✓' : '✗'}
          </div>
          ...
          {/* Song information */}
          <div className="bg-white/20 backdrop-blur-md rounded-3xl p-8 mx-4">
            ...
            <div className="text-xl font-bold bg-white/30 rounded-xl px-6 py-3 inline-block">
              Released: {cardPlacementResult.song.release_year}
            </div>
          </div>
        </div>
      </div>
